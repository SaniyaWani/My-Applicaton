...
export default class Nextdaystime extends Component {
    ...
    getTime = async () => { 
        ...
        await fetch('http://api.aladhan.com/v1/calendar?latitude=20.5937&longitude=78.9629&method=2&month=' + month + '&year=' + year + '')
            ...
            .then(data => {
                ...
                this.setState({ 
                    fechtedInfo:data.data[date].hijri,
                    fetchedInformation: data.data[date].timings 
                })
            })
            .catch(err => {
        ...
        return (
            ...
            <View style={styles.whole}>
                ...
                onPress={() =>this.props.navigation.navigate('HomeScreen')}/>
                    <Text style={{ fontSize: 40 }}>Tomorrow's Time</Text>
                </View>
